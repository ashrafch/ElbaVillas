    ...
    <article className="group overflow-hidden bg-card">
      <div className="relative aspect-[5/4] overflow-hidden sm:aspect-[4/5]">
        ...
        <div className="absolute bottom-4 left-4 right-4 text-white">
          ...
          <p className="mt-2 line-clamp-3 text-sm leading-6 text-white/75">{villa.description}</p>
        </div>
      </div>
      <div className="border border-border/80 border-t-0 p-5">
        ...
        <div className="mt-4 flex items-center justify-between gap-4">
          <span className="inline-flex items-center gap-2 text-[0.68rem] uppercase tracking-[0.14em] text-muted-foreground sm:text-xs sm:tracking-[0.18em]">
