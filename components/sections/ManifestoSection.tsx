    ...
    <span className={`block${italic ? " text-white/60" : ""}`}>
      {words.map((word, i) => (
        <span key={i} className="mr-[0.28em] inline-block overflow-hidden last:mr-0">
          <motion.span
            className={`inline-block${italic ? " italic" : ""}${italic ? " pr-[0.1em]" : ""}`}
...
export function ManifestoSection() {
  ...
  return (
    <section ref={ref} className="relative bg-[#172522] py-28 lg:py-44">
      <div className="absolute inset-x-0 top-0 h-px bg-white/10" />

      <div className="container-premium">
        <div className="mx-auto max-w-5xl">
          <p
            className="font-heading text-[clamp(2.5rem,6vw,5.5rem)] leading-[1.1] tracking-[-0.025em] text-white"
          ...
          >
            ...
            <span className="text-[0.58rem] uppercase tracking-[0.32em] text-white/28">
